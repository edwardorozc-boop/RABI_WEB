...
def clasificar_exposicion(
    ...
    if es_realmente_observable:
        # El animal tiene dueno y puede mantenerse en observacion 10 dias:
        # se clasifica directo como No exposicion, sin importar si esta
        # vacunado, el tipo de agresion (mordedura/rasguño) ni la localizacion.
        motivos.append("El animal tiene dueno y puede mantenerse en observacion durante 10 dias")
